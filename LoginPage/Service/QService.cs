...
namespace LoginPage.Service
{
    public class QService
    {
        ...
        private void FillList()
        {
            ...
            Qs.Add(new Q { QTitle = "Whats is the capital of China?", AnsCorrect = "Beijing", A1 = "Bangkok",A2 =  "Tel Aviv",A3 = "China", PlayerId =1, SubjectId = 3,StatusId = 2, Status = statusService.StatusQs[1], Subject = subjectQ.SubjectQs[2] });
